...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220408112800947.png" alt="image-20220408112800947" loading="lazy"></p><h5 id="_2-1-5-2-\u663E\u793A\u6240\u6709\u8FDB\u7A0B\u57FA\u672C\u4FE1\u606F" tabindex="-1"><a class="header-anchor" href="#_2-1-5-2-\u663E\u793A\u6240\u6709\u8FDB\u7A0B\u57FA\u672C\u4FE1\u606F" aria-hidden="true">#</a> 2.1.5.2 <strong>\u663E\u793A\u6240\u6709\u8FDB\u7A0B\u57FA\u672C\u4FE1\u606F</strong></h5><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">ps</span> -ef
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220408112951231.png" alt="image-20220408112951231" loading="lazy"></p><h5 id="_2-1-5-3-\u641C\u7D22\u4E0E\u5B57\u7B26\u4E32\u5339\u914D\u7684\u8FDB\u7A0B" tabindex="-1"><a class="header-anchor" href="#_2-1-5-3-\u641C\u7D22\u4E0E\u5B57\u7B26\u4E32\u5339\u914D\u7684\u8FDB\u7A0B" aria-hidden="true">#</a> 2.1.5.3 \u641C\u7D22\u4E0E\u5B57\u7B26\u4E32\u5339\u914D\u7684\u8FDB\u7A0B</h5><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code> <span class="token function">ps</span> -aux <span class="token operator">|</span> <span class="token function">grep</span> nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220408113035249.png" alt="image-20220408113035249" loading="lazy"></p><h5 id="_2-1-5-4-\u67E5\u770Bcpu-\u8D44\u6E90\u7684\u4F7F\u7528\u91CF\u5BF9\u8FDB\u7A0B\u8FDB\u884C\u6392\u5E8F" tabindex="-1"><a class="header-anchor" href="#_2-1-5-4-\u67E5\u770Bcpu-\u8D44\u6E90\u7684\u4F7F\u7528\u91CF\u5BF9\u8FDB\u7A0B\u8FDB\u884C\u6392\u5E8F" aria-hidden="true">#</a> 2.1.5.4 <strong>\u67E5\u770BCPU \u8D44\u6E90\u7684\u4F7F\u7528\u91CF\u5BF9\u8FDB\u7A0B\u8FDB\u884C\u6392\u5E8F</strong></h5><p>\u9ED8\u8BA4\u7684\u7ED3\u679C\u96C6\u662F\u672A\u6392\u597D\u5E8F\u7684\u3002\u53EF\u4EE5\u901A\u8FC7 sort\u547D\u4EE4\u6765\u6392\u5E8F\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">ps</span> -aux <span class="token operator">|</span> <span class="token function">sort</span> -nk <span class="token number">3</span>
