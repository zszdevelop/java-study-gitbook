import{_ as a}from"./plugin-vue_export-helper.21dcd24c.js";import{o as t,c as p,a as n,b as e,e as o,d as c,r as i}from"./app.5d5ee434.js";const l={},u=o(`<h1 id="minio\u5165\u95E8-springboot\u96C6\u6210minio" tabindex="-1"><a class="header-anchor" href="#minio\u5165\u95E8-springboot\u96C6\u6210minio" aria-hidden="true">#</a> Minio\u5165\u95E8-SpringBoot\u96C6\u6210Minio</h1><h2 id="_1-\u524D\u8A00" tabindex="-1"><a class="header-anchor" href="#_1-\u524D\u8A00" aria-hidden="true">#</a> 1. \u524D\u8A00</h2><p>\u4E4B\u524D\u4ECB\u7ECD\u4E86\u5982\u4F55\u4F7F\u7528Minio\u63D0\u4F9B\u7684JAVA SDK\u8FDB\u884C\u4E0A\u4F20\u548C\u4E0B\u8F7D\u6587\u4EF6\uFF0C\u5728\u6B64\u57FA\u7840\u4E0A\uFF0C\u6211\u4EEC\u53EF\u4EE5\u4F7F\u7528spring boot\u96C6\u6210Minio JAVA SDK\uFF0C\u6DFB\u52A0\u81EA\u52A8\u914D\u7F6E\u3001\u88C5\u914D\u3001\u5BA2\u6237\u7AEF\u7BA1\u7406\u7B49\u529F\u80FD\uFF0C\u7B80\u5316\u5F00\u53D1\u3002</p><h2 id="_2-spring-boot\u96C6\u6210minio" tabindex="-1"><a class="header-anchor" href="#_2-spring-boot\u96C6\u6210minio" aria-hidden="true">#</a> 2. Spring Boot\u96C6\u6210Minio</h2><h3 id="_2-1-\u73AF\u5883\u642D\u5EFA" tabindex="-1"><a class="header-anchor" href="#_2-1-\u73AF\u5883\u642D\u5EFA" aria-hidden="true">#</a> 2.1 \u73AF\u5883\u642D\u5EFA</h3><p>\u9996\u5148\u6211\u4EEC\u642D\u5EFA\u4E00\u4E2Aspring boot\u57FA\u7840\u5DE5\u7A0B\uFF0C\u5F15\u5165\u4EE5\u4E0B\u4F9D\u8D56</p><div class="language-java ext-java line-numbers-mode"><pre class="language-java"><code>    <span class="token generics"><span class="token punctuation">&lt;</span>dependencies<span class="token punctuation">&gt;</span></span>
        ...
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            ...
            <span class="token generics"><span class="token punctuation">&lt;</span>version<span class="token punctuation">&gt;</span></span><span class="token number">8.3</span><span class="token number">.1</span><span class="token operator">&lt;</span><span class="token operator">/</span>version<span class="token operator">&gt;</span>
        <span class="token operator">&lt;</span><span class="token operator">/</span>dependency<span class="token operator">&gt;</span>
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            <span class="token generics"><span class="token punctuation">&lt;</span>groupId<span class="token punctuation">&gt;</span></span>me<span class="token punctuation">.</span>tongfei<span class="token operator">&lt;</span><span class="token operator">/</span>groupId<span class="token operator">&gt;</span>
            <span class="token generics"><span class="token punctuation">&lt;</span>artifactId<span class="token punctuation">&gt;</span></span>progressbar<span class="token operator">&lt;</span><span class="token operator">/</span>artifactId<span class="token operator">&gt;</span>
        ...
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            ...
            <span class="token generics"><span class="token punctuation">&lt;</span>version<span class="token punctuation">&gt;</span></span><span class="token number">4.9</span><span class="token number">.2</span><span class="token operator">&lt;</span><span class="token operator">/</span>version<span class="token operator">&gt;</span>
        <span class="token operator">&lt;</span><span class="token operator">/</span>dependency<span class="token operator">&gt;</span>
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            ...
            <span class="token generics"><span class="token punctuation">&lt;</span>version<span class="token punctuation">&gt;</span></span><span class="token number">5.7</span><span class="token number">.13</span><span class="token operator">&lt;</span><span class="token operator">/</span>version<span class="token operator">&gt;</span>
        <span class="token operator">&lt;</span><span class="token operator">/</span>dependency<span class="token operator">&gt;</span>
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            <span class="token generics"><span class="token punctuation">&lt;</span>groupId<span class="token punctuation">&gt;</span></span>org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>boot<span class="token operator">&lt;</span><span class="token operator">/</span>groupId<span class="token operator">&gt;</span>
        ...
        <span class="token generics"><span class="token punctuation">&lt;</span>dependency<span class="token punctuation">&gt;</span></span>
            ...
            <span class="token generics"><span class="token punctuation">&lt;</span>version<span class="token punctuation">&gt;</span></span><span class="token number">1.4</span><span class="token operator">&lt;</span><span class="token operator">/</span>version<span class="token operator">&gt;</span>
        <span class="token operator">&lt;</span><span class="token operator">/</span>dependency<span class="token operator">&gt;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="\u53C2\u8003\u6587\u7AE0" tabindex="-1"><a class="header-anchor" href="#\u53C2\u8003\u6587\u7AE0" aria-hidden="true">#</a> \u53C2\u8003\u6587\u7AE0</h2>`,28),r={href:"https://yunyanchengyu.blog.csdn.net/article/details/120920171",target:"_blank",rel:"noopener noreferrer"},k=c("Minio\u5165\u95E8\u7CFB\u5217\u301012\u3011Spring Boot\u96C6\u6210Minio");function d(m,v){const s=i("ExternalLinkIcon");return t(),p("div",null,[u,n("p",null,[n("a",r,[k,e(s)])])])}var f=a(l,[["render",d],["__file","C2-Minio\u5165\u95E8-SpringBoot\u96C6\u6210Minio.html.vue"]]);export{f as default};
