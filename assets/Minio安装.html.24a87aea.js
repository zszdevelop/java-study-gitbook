...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/blogimage-master/image-20210925212415270.png" alt="image-20210925212415270"></p><h3 id="_2-2-docker\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#_2-2-docker\u5B89\u88C5" aria-hidden="true">#</a> 2.2 docker\u5B89\u88C5</h3><p>\u6CE8\uFF1A\u8DDF\u4E2D\u6587\u5B98\u7F51\u6709\u5DE8\u5927\u4E0D\u540C\u3002\u4E2D\u6587\u5B98\u7F51\u6CA1\u6709\u6307\u5B9Aconsole\u7AEF\u53E3</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -p <span class="token number">9000</span>:9000 -p <span class="token number">9001</span>:50000 --name minio <span class="token punctuation">\\</span>
-v /mnt/data:/data <span class="token punctuation">\\</span>
-v /mnt/config:/root/.minio <span class="token punctuation">\\</span>
minio/minio server --console-address <span class="token string">&quot;:9001&quot;</span> /data
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>MinIO\u81EA\u5B9A\u4E49\u7528\u6237\u540D\u5BC6\u7801</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> run -d -p <span class="token number">9000</span>:9000 -p <span class="token number">9001</span>:50000 --name minio <span class="token punctuation">\\</span>
-e <span class="token string">&quot;MINIO_ROOT_USER=admin&quot;</span> <span class="token punctuation">\\</span>
-e <span class="token string">&quot;MINIO_ROOT_PASSWORD=12345678&quot;</span> <span class="token punctuation">\\</span>
-v /mnt/data:/data <span class="token punctuation">\\</span>
-v /mnt/config:/root/.minio <span class="token punctuation">\\</span>
minio/minio server --console-address <span class="token string">&quot;:9001&quot;</span> /data
...
x<span class="token operator">-</span>minio<span class="token operator">-</span>common<span class="token operator">:</span> <span class="token operator">&amp;</span>minio<span class="token operator">-</span>common
  ...
  environment<span class="token operator">:</span>
    MINIO_ROOT_USER<span class="token operator">:</span> minioadmin
    MINIO_ROOT_PASSWORD<span class="token operator">:</span> minioadmin
