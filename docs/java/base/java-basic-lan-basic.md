...
![image-20220812211827529](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220812211827529.png)
...
### 2.5 **HotSpot中字符串常量池保存哪里？永久代？方法区还是堆区**？
...
![image-20220812224420159](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220812224420159.png)
...
相关文章：[Java 基础 - 泛型机制详解](https://pdai.tech/md/java/basic/java-basic-x-generic.html)

## 10. 注解

Java 注解是附加在代码中的一些元信息，用于一些工具在编译、运行时进行解析和使用，起到说明、配置的功能。注解不会也不能影响代码的实际逻辑，仅仅起到辅助性的作用。

相关文章：[Java 基础 - 注解机制详解](https://pdai.tech/md/java/basic/java-basic-x-annotation.html)
