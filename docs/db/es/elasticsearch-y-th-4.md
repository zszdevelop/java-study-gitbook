...
![image-20220808221429209](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808221429209.png)

### 1.2 多个文档

使用 mget 取回多个文档的步骤顺序：

![image-20220808221800004](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808221800004.png)
...
![image-20220808221936950](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808221936950.png)
...
![image-20220808223758482](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808223758482.png)
...
![image-20220808223857396](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808223857396.png)
...
![image-20220808224107769](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808224107769.png)
...
![image-20220808224234287](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808224234287.png)
...
### 3.4 Elasticsearch查询流程

Elasticsearch中的大部分查询，以及核心功能都是Search类型查询，上面我们了解到查询分为一阶段，二阶段和三阶段，这里我们就以最常见的的二阶段查询为例来介绍查询流程。

![image-20220808224453254](https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220808224453254.png)
