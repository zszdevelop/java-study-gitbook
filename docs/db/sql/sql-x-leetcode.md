...
> 第一遍没做出来，异或方案应该想不到，但case when 要想到才对
...
>我第一遍的方案是查出部门中工资最高的员工，再匹配这个公司对应的人。但这样可能存在多个工资一样的人
...
>1. 这题单单给结果返回序号还不够，同名的都需要为第一名
>2. 178 答案有点问题，网上找了好几个也不能直接执行
